...
Scanner s=new Scanner(System.in); System.out.println("Enter Number Of Process U want 2
Execute---");
n=s.nextInt();
int arrival[]=new int[n]; int cpu[]=new int[n];
int pri[]=new int[n]; int finish[]=new int[n]; int turntt[]=new int[n]; int wait[]=new int[n];
...
System.out.println("Enter Priority of "+(i+1)+" Process pri[i]=s.nextInt();
process[i]=i+1;
